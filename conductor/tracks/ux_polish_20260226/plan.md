...
## Phase 6: Animation Fixes (Mobile & Loop) [checkpoint: a78dba7]
- [x] Task: Fix Animation Looping [a78dba7]
    - [x] Update `src/index.css` to limit `heart-beat` to 2 iterations instead of `infinite`. [a78dba7]
    - [x] Ensure `OutcomeOverlay` timing matches the CSS duration. [a78dba7]
- [x] Task: Fix Mobile Visibility [a78dba7]
    - [x] Refactor `OutcomeOverlay` styling to ensure it is visible on mobile viewports. [a78dba7]
    - [x] Remove conflicting `pointer-events` classes. [a78dba7]
- [x] Task: Conductor - User Manual Verification 'Phase 6: Animation Fixes' (Protocol in workflow.md) [a78dba7]
