...
1. <MATH_QUESTION>: The original math problem.
2. <USER_RESPONSE>: The user's text, which includes their step-by-step process, reasoning, and their final answer.
...
<USER_RESPONSE>:[Insert User's Text Here]
